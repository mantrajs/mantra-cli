...
import {createDir, getFileContent, createFile, runScriptFile} from '../utils';
...
export default function create(appPath) {
  ...
  if (process.env.NODE_ENV !== 'test') {
    runScriptFile(`${__dirname}/../../scripts/init.sh`, [appPath]);
  }
  ...
  if (process.env.NODE_ENV !== 'test') {
    runScriptFile(`${__dirname}/../../scripts/after_init.sh`, [], {cwd: `./${appPath}`});
  }
