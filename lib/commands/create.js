...
import {getCustomConfig} from '../config_utils';
...
export default function create(appPath, options = {}) {
  ...
  const config = getCustomConfig({ storybook: Boolean(options.storybook) });
  ...
  createFile(`${templatesPath}/client/modules/core/index.js`,
           `${targetModulePath}/core/index.js`);
  createFile(`${templatesPath}/client/modules/core/routes.jsx`,
           `${targetModulePath}/core/routes.jsx`);
  createDir(`${targetModulePath}/core/containers`);
  createDir(`${targetModulePath}/core/configs`);
  createDir(`${targetModulePath}/core/libs`);
  */
  ...
  if (options.storybook) {
    ...
    /*createDir(`${targetModulePath}/core/components/.stories`);
    createFile(`${templatesPath}/client/modules/core/components/.stories/index.js`,
      `${targetModulePath}/core/components/.stories/index.js`);
    */
  }

  // Generate test directories
  /*
  createDir(`${targetModulePath}/core/containers/tests`);
  createDir(`${targetModulePath}/core/actions/tests`);
  createDir(`${targetModulePath}/core/components/tests`);
  */
  shelljs.cd(appPath);
