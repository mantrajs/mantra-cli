...
export function readConfig() {
  let configPath = './mantra_cli.yaml';
  let defaultConfigPath = path.resolve(__dirname, '../templates/mantra_cli.yaml');
  let defaultConfig = parseYamlFromFile(defaultConfigPath);
  let userConfig = {};

  if (checkFileExists(configPath)) {
    userConfig = parseYamlFromFile(configPath);
  }
