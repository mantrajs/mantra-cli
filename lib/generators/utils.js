...
function getTemplatePath(type, options = {}) {
  ...
  if (options.testTemplate) {
    if (type === 'component') {
      ...
      relativePath = '../../templates/client/modules/core/containers/test/test.tt';
    } else if (type === 'action') {
      relativePath = '../../templates/client/modules/core/actions/test/test.tt';
    }
  } else {
    if (type === 'collection') {
...
function readTemplateContent(type, templateOptions) {
  console.log('opts', templateOptions);
